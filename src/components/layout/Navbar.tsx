      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center gap-8">
            <a href="#" className="flex items-center gap-1.5 text-2xl font-bold tracking-tight">
              <span className="text-[#008BD3]">intern</span>
              <span className="text-[#00A5EC]">shala</span>
              <span className="text-[10px] uppercase font-bold tracking-wider px-1.5 py-0.5 rounded bg-brand-blue-light text-brand-blue border border-brand-blue/15">
                Clone
              </span>
            </a>
            ...
            <div className="hidden md:flex items-center space-x-6">
              {NAV_LINKS.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="text-sm font-semibold text-brand-gray-dark hover:text-brand-blue transition-colors"
                >
                  {link.label}
                </a>
              ))}
          ...
          <div className="hidden sm:flex items-center relative w-72">
            ...
            <input
              ...
              className="w-full h-9 pl-9 pr-8 text-sm bg-brand-gray-light border border-brand-gray-border rounded focus:outline-none focus:ring-1 focus:ring-brand-blue focus:border-brand-blue focus:bg-white transition-all"
            />
            {localSearch && (
              <button
                onClick={handleClear}
                className="absolute right-3 text-xs text-brand-gray hover:text-brand-gray-dark cursor-pointer"
              >
                Clear
              </button>
            )}
          ...
          <div className="flex md:hidden items-center">
            <button
              ...
              className="text-brand-gray-dark hover:text-brand-blue focus:outline-none cursor-pointer"
            >
